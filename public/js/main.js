(function () {
  ...
  var menuHover = function () {
    if (!isMobile.any()) {
      jQuery(".probootstrap-navbar .navbar-nav li.dropdown").hover(
        function () {
          jQuery(this)
            .find("> .dropdown-menu")
            .stop(true, true)
  ...
  var showcase = function () {
    jQuery(".probootstrap-showcase-nav ul li a").on("click", function (e) {
      ...
      $this
        .closest(".probootstrap-feature-showcase")
        .find(".probootstrap-showcase-nav ul li")
        .removeClass("active");
      $this.closest("li").addClass("active");

      $this
        .closest(".probootstrap-feature-showcase")
        .find(".probootstrap-images-list li")
        .removeClass("active");
      $this
        .closest(".probootstrap-feature-showcase")
        .find(".probootstrap-images-list li")
  ...
  var contentWayPoint = function () {
    var i = 0;
    jQuery(".probootstrap-animate").waypoint(
      function (direction) {
        if (
          direction === "down" &&
          !jQuery(this.element).hasClass("probootstrap-animated")
        ) {
          i++;

          jQuery(this.element).addClass("item-animate");
          setTimeout(function () {
            jQuery("body .probootstrap-animate.item-animate").each(function (
              k
            ) {
              var el = jQuery(this);
              setTimeout(
  ...
  var counterWayPoint = function () {
    if (jQuery("#probootstrap-counter").length > 0) {
      jQuery("#probootstrap-counter").waypoint(
        function (direction) {
          if (
            direction === "down" &&
            !jQuery(this.element).hasClass("probootstrap-animated")
