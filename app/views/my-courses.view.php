      ...
      <div class="col-md-12">
        <div class="probootstrap-flex-block">
          <div class="probootstrap-text probootstrap-animate">
            <div class="text-uppercase probootstrap-uppercase">
              Featured Course
            </div>
            ...
            <?php foreach ($courses as $course) : ?>
                <div class="col-md-6">
                    <div class="probootstrap-service-2 probootstrap-animate">
                        ...
                        <div class="text">
                            <span class="probootstrap-meta"><i class="fa-solid fa-hashtag"></i><?= $course->getId() ?></span>
                            <h3><?= $course->getTitle() ?></h3>
                            <p>
                                <?= $course->getDescription() ?>
                            </p>
                            
                                <a href="/course/<?= $course->getId() ?>" class="btn btn-primary" style="display: inline;">More details</a>
                                <form action="/unsign-course/<?= $course->getId() ?>" method="post" style="display: inline;">
                                <button class="btn btn-danger" type="submit" style="display: inline;">Unenroll</button>
                            </form>
